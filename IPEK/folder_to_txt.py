...
#Change these
dbName = 'lfw-deepfunneled' #IBUG, LFPW, HELEN, AFW, IBUG, YoutubeFace, LFW
logFolderPath = './IPEK/lfw-deepfunneled/'+ dbName
dbName = './IPEK/'+dbName
txtInfoPath = './IPEK/lfw-deepfunneled.txt' #only for imgTxtDBs
...
if dbName == './UMUT/YoutubeFace' or dbName == './IPEK/lfw-deepfunneled':
    imgTxtDBs = True
else:
    imgTxtDBs = False
