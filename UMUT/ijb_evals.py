...
class Torch_model_interf:
    def __init__(self, model_file, image_size=(112, 112)):
        ...
        device_name = "cuda:2" if len(cvd) > 0 and int(cvd) != -1 else "cpu"
...
def parse_arguments(argv):
    ...
    parser.add_argument("-m", "--model_file", type=str, default='/run/media/mlcv/SSD2/Hasan/NirvanaFace2/Networks/ms1m_v3_arcface_r100_fp16.pth', help="Saved model, keras h5 / pytorch jit pth / onnx / mxnet")
