...
def main(changed_dataset, original_dataset):
    ...
    changed_folder = os.path.dirname(changed_dataset)
    changed_dataset = os.path.normpath(changed_dataset)
    output_path = os.path.join(changed_folder, changed_dataset.split('\\')[-1] + '_missing_files.txt')
...
if __name__ == '__main__':
    main(changed_dataset = 'UMUT/database/AFW_FOLDERED_without_errors', original_dataset = 'UMUT\LFPW_FOLDERED')
